...
const getVariantStyles = (variant: "heading" | "body" | "action") => {
  const styles = {
    ...
    action:
      "font-semibold leading-normal tracking-[0.015em] transition-colors cursor-pointer font-display",
  };
...
export default function Typography({
  ...
  return (
    <Component
      className={cn(variantStyles, sizeStyles, colorStyles, className)}
      {...props}
    >
      {children}
    </Component>
...
export const Action = ({
  ...
  <Typography variant="action" {...props}>
    {children}
  </Typography>
);
