...
const BookingBodyModal = () => {
  return (
    <div className="grid grid-cols-1 border border-neutral-200 rounded-xl overflow-hidden cursor-pointer hover:border-primary/50 hover:bg-neutral-50 transition-all">
